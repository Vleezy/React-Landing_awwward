...
const Hero = () => {
    ...
    // logic: 4 % 4 = 1 + 1 => 1 starts over from 1 once reaching 0
    ...
    useGSAP(() => {
        if (hasClicked) {
            ...
            gsap.from('current-video', {
                transform: 'center center', scale: '0', duration: 1.5, ease: 'power1.inOut',
            })
        }
    }, {dependencies: [currentIndex], revertOnUpdate: true})

    // create custom clip path: https://bennettfeely.com/
    useGSAP(() => {
        ...
        gsap.from('#video-frame', {
            ...
            ease: 'power1.inOut',
            scrollTrigger: {
                trigger: 'video-frame', start: 'center center', end: 'bottom center', scrub: true,
            }
        })
    })
